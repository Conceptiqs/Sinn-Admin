          ...
          <TableBody>
            {paginatedCustomers.map((customer) => (
              <TableRow key={customer.id} hover>
                ...
                <TableCell sx={{ fontSize: "14px" }}>{customer.mobile}</TableCell>
                <TableCell sx={{ fontSize: "14px" }}>{customer.email}</TableCell>
                <TableCell sx={{ fontSize: "14px" }}>{customer.dob}</TableCell>
                <TableCell sx={{ fontSize: "14px" }}>{customer.gender}</TableCell>
                <TableCell sx={{ fontSize: "14px" }}>{customer.location}</TableCell>
